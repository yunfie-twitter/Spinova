...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.show_bytes_cb.setVisible(False)  # 非表示
    ...
    def open_settings_dialog(self):
        ...
        if dialog.exec_():
            ...
            self.config_manager.set(
                "yt_dlp_opts", json.dumps(self.yt_dlp_opts, ensure_ascii=False)
            )
    ...
    def start_download(self):
        ...
        format_code = self.plugin_manager.get_all_formats().get(
            selected_fmt_name, "bestvideo+bestaudio/best"
        )
